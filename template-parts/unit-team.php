<section class="mol--section-team d-flex flex-row">
	<div class="atm--headshot">
        ...
        <?php } else { ?>
        	<figure class="headshot-logo">
            	<img src="<?php echo get_template_directory_uri(); ?>/assets/images/BoomLogo-Green-Outlined.svg"/>
        	</figure>
        <?php } ?>
	</div>
	<div class="atm--details">
		...
		<ul class="team--questions">
			<li><span class="ut--green">Favourite tennis player</span>&nbsp;<?php the_field('fav_tennis_player'); ?></li>
			<li><span class="ut--green">Dream doubles partner</span>&nbsp;<?php the_field('dream_doubles_part'); ?></li>
